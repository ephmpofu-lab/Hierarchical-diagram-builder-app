...
class KnowledgeRepository(Protocol):
    ...
    Phase 2 Blueprint ("interface defined now -- not yet populated"); WP1 populated the
    storage shape, WP3 (Knowledge Layer MVP, Phase 6) adds the acquisition/lifecycle/
    retrieval behavior that actually uses it."""
